...
const drawFrame = (time) => {
    ...
    drawFilledCircle((time/11)%width, (time/10)%height, 25, 'blue');
    drawFilledCircle((time/12)%width, (time/10)%height, 25, 'black');
    drawFilledCircle((time/13)%width, (time/10)%height, 25, 'red');
}
