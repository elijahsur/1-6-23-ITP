...
const drawFrame = (time) => {
    ...
    drawFilledCircle((time/5)%width, (time/10 - 5)%height, 25, 'gold');
    drawFilledCircle((time/7)%width, (time/10 - 10)%height, 25, 'black');
    drawFilledCircle((time/12)%width, (time/10 - 15)%height, 25, '2E5A52');
}
