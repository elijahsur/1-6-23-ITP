...
const drawFrame = (time) => {
    clear();
    drawFilledCircle((time/10)%width, (time/10)%height, 25, 'blue');
    drawFilledCircle((time/5)%width, (time/5)%height, 25, 'gray');
    drawFilledCircle((time/7)%width, (time/7)%height, 25, 'gold');
}
