...
const drawFrame = (time) => {
    ...
    drawFilledCircle((time/10 + 2)%width, (time/10)%height, 25, 'blue');
    drawFilledCircle((time/10 + 4)%width, (time/10)%height, 25, 'black');
    drawFilledCircle((time/10 + 8)%width, (time/10)%height, 25, 'red');
}
