...
const drawFrame = (time) => {
    ...
    drawFilledCircle((time/10 + 40)%width, (time/10)%height, 25, 'blue');
    drawFilledCircle((time/10 + 80)%width, (time/10)%height, 25, 'black');
    drawFilledCircle((time/10 + 120)%width, (time/10)%height, 25, 'red');
}
